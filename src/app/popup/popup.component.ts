...
export class PopupComponent {
  ...
  // import the services using a constructor => only 1 constructor is allowed PER CLASS, if you want to include multiple services, include them in the same constructor !!
  constructor(
